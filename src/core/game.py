...
class GameEngine:
    ...
    def __init__(self, pantalla: pygame.Surface, reloj: pygame.time.Clock, sprites_personajes: Dict, fondo_seleccionado: str,personaje1_nombre: str = "goku",personaje2_nombre: str = "freezer",es_modo_torre: bool = False,audio_manager: Optional[AudioManager] = None) :
